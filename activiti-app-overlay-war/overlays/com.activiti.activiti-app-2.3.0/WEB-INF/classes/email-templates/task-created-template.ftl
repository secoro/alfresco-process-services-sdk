					...
					<table style="background-color: #ffffff;" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td valign="top" style="font-size: 14px;font-family: 'Open Sans', Helvetica, sans-serif;">
								${taskCreator} created <#if taskName?has_content>the task '${taskName}'<#else>a nameless task</#if> for you. <br />The task appears in your Alfresco Process Services inbox.
							</td>
							<td width="15"></td>
						</tr>
