					...
					<table style="background-color: #ffffff;" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td valign="top" style="font-size: 14px;font-family: 'Open Sans', Helvetica, sans-serif;">
								${sharedBy} shared the process model '${modelName}' with you. This process model will now appear in your 'shared with me' list.
							</td>
							<td width="15"></td>
						</tr>
								...
								<table style="background-color: #ffffff;" width="100%" cellpadding="0" cellspacing="0">
									<tr>
										<td valign="middle" style="font-size: 15px;font-family: 'Open Sans', Helvetica, sans-serif; text-align: left; font-weight: bold;  color: #ffffff;">
											<a href="${modelUrl}" title="View model in Alfresco Process Services" style="text-decoration: none; text-align: center;color: #ffffff; display: inline-block; width: 200px; padding: 10px 0px;background-color: #36a7c4; border-radius: 3px; -moz-border-radius: 3px; -webkit-border-radius: 3px;">View process model</a>
										</td>
									</tr>
								</table>
							</td>
