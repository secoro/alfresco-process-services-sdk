			...
			<tr>
				...
				<td width="80%" valign="top" >
					<table style="background-color: #ffffff;" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td width="15"></td>
							<td valign="center"style="font-size: 16px;font-family: 'Open Sans', Helvetica, sans-serif; font-weight: bold; ">A task is created for the group '${groupName}'!</td>
							<td width="15"></td>
						</tr>
						<tr height="15"><td colspan="3"></td></tr>
						...
						<tr>
							...
							<td valign="top" style="font-size: 14px;font-family: 'Open Sans', Helvetica, sans-serif;">
								<#if taskName?has_content>The task '${taskName}'<#else>A nameless task</#if> was created for a group you are a member of. <br />The task appears in your Alfresco Process Services inbox.
							</td>
							<td width="15"></td>
						</tr>
