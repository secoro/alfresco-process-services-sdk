			...
			<tr>
				...
				<td width="80%" valign="top" >
					<table style="background-color: #ffffff;" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td width="15"></td>
							<td valign="center"style="font-size: 16px;font-family: 'Open Sans', Helvetica, sans-serif; font-weight: bold; ">${sharedBy} shared an app model with you!</td>
							<td width="15"></td>
						</tr>
						<tr height="15"><td colspan="3"></td></tr>
						...
						<tr>
							...
							<td valign="top" style="font-size: 14px;font-family: 'Open Sans', Helvetica, sans-serif;">
								${sharedBy} shared the app definition '${modelName}' with you. This app definition will now appear in your 'shared with me' list.
							</td>
							<td width="15"></td>
						</tr>
								...
								<table style="background-color: #ffffff;" width="100%" cellpadding="0" cellspacing="0">
									<tr>
										<td valign="middle" style="font-size: 15px;font-family: 'Open Sans', Helvetica, sans-serif; text-align: left; font-weight: bold;  color: #ffffff;">
											<a href="${modelUrl}" title="View model in Alfresco Process Services" style="text-decoration: none; text-align: center;color: #ffffff; display: inline-block; width: 200px; padding: 10px 0px;background-color: #36a7c4; border-radius: 3px; -moz-border-radius: 3px; -webkit-border-radius: 3px;">View app definition</a>
										</td>
									</tr>
								</table>
							</td>
