			...
			<tr>
				...
				<td width="80%" valign="top" >
					<table style="background-color: #ffffff;" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td width="15"></td>
							<td valign="center"style="font-size: 16px;font-family: 'Open Sans', Helvetica, sans-serif; font-weight: bold; ">${processCreator} has created a process with a task definition that involves you!</td>
							<td width="15"></td>
						</tr>
						<tr height="15"><td colspan="3"></td></tr>
						...
						<tr>
							...
							<td valign="top" style="font-size: 14px;font-family: 'Open Sans', Helvetica, sans-serif;">
								${processCreator} created a process '${processName}' with a task definition that involves you. <br />In order to work with this process and view your Alfresco Process Services inbox, you'll need to create an Alfresco Process Services account. It will only take a minute and you're good to go!
							</td>
							<td width="15"></td>
						</tr>
